...
def main(req):
  ...
  try:
      ...
      if(action != "Create") :
        logging.error("The action in request body doesn't match the triggered function : Create_Twins_Orchestrator")
        return
  except:
  ...
  try:
      ...
      if(element != "Twin") :
        logging.error("The element in request body doesn't match the triggered function : Create_Twins_Orchestrator")
        return
  except:
