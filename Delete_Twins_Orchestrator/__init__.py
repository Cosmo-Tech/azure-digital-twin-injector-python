...
def main(req):
    ...
    try:
        ...
        if action != "Delete":
            logging.exception(
                "Dev Log: The action in request body doesn't match the triggered function : Delete_Twins_Orchestrator"
            )
            return
    except Exception:
    ...
    try:
        ...
        if element != "Twin":
            logging.exception(
                "Dev Log: The element in request body doesn't match the triggered function : Delete_Twins_Orchestrator"
            )
            return
    except Exception:
