...
def main(req):
    ...
    try:
        ...
        if action != "Create":
            logging.error(
                "Dev Log: The action in request body doesn't match the triggered function : Create_Relationships_Orchestrator"
            )
            return
    except Exception:
    ...
    try:
        ...
        if element != "Relationship":
            logging.error(
                "Dev Log: The element in request body doesn't match the triggered function : Create_Relationships_Orchestrator"
            )
            return
    except Exception:
