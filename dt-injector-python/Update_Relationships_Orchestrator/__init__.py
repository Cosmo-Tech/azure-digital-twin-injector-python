...
def main(req):
  ...
  try:
      ...
      if(action != "Update") :
        logging.error("Dev Log: The action in request body doesn't match the triggered function : Update_Relationships_Orchestrator")
        return
  except:
  ...
  try:
      ...
      if(element != "Relationship") :
        logging.error("Dev Log: The element in request body doesn't match the triggered function : Update_Relationships_Orchestrator")
        return
  except:
