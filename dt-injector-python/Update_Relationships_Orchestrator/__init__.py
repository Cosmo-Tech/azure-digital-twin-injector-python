...
def main(req):
  ...
  try:
      ...
      if(action != "Update") :
        logging.error("The action in request body doesn't match the triggered function : Update_Relationships_Orchestrator")
        return
  except:
  ...
  try:
      ...
      if(element != "Relationship") :
        logging.error("The element in request body doesn't match the triggered function : Update_Relationships_Orchestrator")
        return
  except:
